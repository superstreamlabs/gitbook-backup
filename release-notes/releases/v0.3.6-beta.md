...
* Factory entity has been removed, from now on only Stations are needed in order to push data towards Memphis
* Stations page has been re-designed and expose more metrics
