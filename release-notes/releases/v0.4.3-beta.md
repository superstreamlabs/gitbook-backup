...
* Schemaverse users using Go SDK can send [protobuf](../../memphis/schemaverse-schema-management/getting-started/protobuf.md) messages by sending map\[string]interface{} type, **without storing the schemas locally.**
