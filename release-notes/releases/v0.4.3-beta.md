...
* [DLS](../../memphis-broker/concepts/dead-letter.md) (dead-letter station) now supports storing messages that violate an attached schema. \
...
* Schemaverse users using Go SDK can send [protobuf](../../memphis-broker/schemaverse-schema-management/formats/produce-consume/protobuf.md) messages by sending map\[string]interface{} type, **without storing the schemas locally.**
