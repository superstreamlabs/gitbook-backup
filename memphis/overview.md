...
Additional Use Grant: You may make use of the Licensed Work (i) only as part of your own product or service, provided it is not a message broker or a message queue product or service; (ii) provided that you do not use, provide, distribute, or make available the Licensed Work as a Service; (iii) Companies with less than $10M in annual revenue or funding. Above that, an enterprise license or a managed service will be needed.
