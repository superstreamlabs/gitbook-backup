...
[memphis.dev](https://memphis.dev/) started as a fork of the [nats.io](http://nats.io/) project (since 2011), written in GoLang, and creating its stream on top. Instead of topics and queues, Memphis uses stations, which in the future, will become an entity with embedded logic.
